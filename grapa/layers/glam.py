...
from kron import kronecker_product_b1fx1 as kron_b1fx1
...
class glam(Layer):#not anymore using keepconst, also not setting the diagonal to zero
  ...
  def __init__(self,gs=20,param=40,a=10,iterations=10,alinearity=[-1.0,1.0],kernel_initializer='glorot_uniform',self_initializer=None,neig_initializer=None,learnable=True,**kwargs):
